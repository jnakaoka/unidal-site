...
type ProjectType = "Industriais" | "Exteriores" | "Projetos Especias";
...
const filters = ["Todos", "Industriais", "Exteriores", "Projetos Especias"] as const;
...
function VideoCard({ title, description, src }: ProjectVideo) {
  return (
...
export default function Projetos() {
  const allProjects: Project[] = [
    ...
    },
    {
      ...
      location: "Zona residencial, França",
      type: "Exteriores",
      image: "/images/betao-impresso-2.jpeg",
    },
    {
      id: 5,
      title: "Acesso exterior em betão",
      location: "Zona residencial, França",
      type: "Projetos Especias",
      image: "/images/betao-impresso.jpeg",
    },
  ];

  // ✅ Ajusta títulos/descrições e nomes dos ficheiros conforme os teus MP4 reais
  const projectVideos: ProjectVideo[] = [
    {
      id: 1,
      title: "Projeto em vídeo — Pavimento industrial",
      description: "Execução e acabamento em ambiente industrial.",
      src: "/videos/projeto-01.mp4",
    },
    {
      id: 2,
      title: "Projeto em vídeo — Exterior em betão",
      description: "Aplicação e resultado final em área exterior.",
      src: "/videos/projeto-02.mp4",
    },
  ];
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10">
      ...
      <section className="mt-12">
        <h2 className="text-2xl font-semibold mb-2">Vídeos dos Projetos</h2>
        <p className="text-slate-600 text-sm md:text-base mb-6">
          Registos em vídeo de alguns trabalhos executados pela UNIDAL.
        </p>
